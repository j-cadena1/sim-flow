...
-- Default users (passwords: admin123, user123, manager123, engineer123)
INSERT INTO users (name, email, password_hash, role, avatar_url) VALUES
    ('qAdmin', 'qadmin@sim-rq.local', '$2b$10$oTh9EogqkPkBWT.9Y0hEKOfW5Wfe2RdfTsucyJizYk1cN23VsY7ie', 'Admin', 'https://api.dicebear.com/7.x/avataaars/svg?seed=qAdmin'),
    ('Alice User', 'alice@sim-rq.local', '$2b$10$lMDP35A/sQxhLCJbgVPGkOjPY9lRMUBMO7MzRRLHLkZJ2RX6e2mee', 'End-User', 'https://api.dicebear.com/7.x/avataaars/svg?seed=alice'),
    ('Bob Manager', 'bob@sim-rq.local', '$2b$10$tNgQPQGmKIVU6E467EKbIed/1Kqbh.D99q/izl2yZ6DSZoqfqmmUS', 'Manager', 'https://api.dicebear.com/7.x/avataaars/svg?seed=bob'),
    ('Charlie Engineer', 'charlie@sim-rq.local', '$2b$10$ZqaYJK.tKOidGRV0OsSGtu9lUCt7J4.sWRKe2Zq8K9JnHv9y04ghy', 'Engineer', 'https://api.dicebear.com/7.x/avataaars/svg?seed=charlie');
