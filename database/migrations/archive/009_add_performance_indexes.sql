...
CREATE INDEX IF NOT EXISTS idx_time_entries_engineer_id ON time_entries(engineer_id);
...
CREATE INDEX IF NOT EXISTS idx_requests_creator_status ON requests(created_by, status);
